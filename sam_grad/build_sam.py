...
from modeling.decoder import MaskLabelDecoder
...
def build_sam_with_gradients_vit_h(checkpoint=None, build_encoder=True):
    '''
    ...
    Returns:
        A tuple of (SAM model, encoder_builder). The encoder_builder is a function that can be used to build the encoder.
    '''
    return _build_sam_with_gradients(
...
def build_sam_with_gradients_vit_l(checkpoint=None, build_encoder=True):
    '''
...
def build_sam_with_gradients_vit_b(checkpoint=None, build_encoder=True):
    '''
...
sam_with_gradients_model_registry = {
    "vit_h": build_sam_with_gradients_vit_h,
    "vit_l": build_sam_with_gradients_vit_l,
    "vit_b": build_sam_with_gradients_vit_b,
}

sam_with_gradients_encoder_builders = {
...
def build_pretrained_encoder(model_type, eval=True):
    encoder = sam_with_gradients_encoder_builders[model_type]()
